...
// Playwright aponta por executablePath para o chromium-browser já
// instalado nesta máquina; nenhum binário de navegador é baixado
// (decisão do líder, 21/09/2026, seção 16). Gecko e WebKit ficam de fora
// do automático, por desenho, não por esquecimento (ver seção 14).
