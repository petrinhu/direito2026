...
export const quiz: readonly PerguntaQuiz[] = [
    { id: 1, categoria: 'teoria', enunciadoHtml: `Segundo H.L.A. Hart, em "O Conceito de Direito", por que a pergunta "o que é o Direito?" é considerada persistente e peculiar em comparação com perguntas como "o que é química?"?`, alternativasHtml: [
    ...
    { id: 2, categoria: 'teoria', enunciadoHtml: `O que Hart chama de "casos-padrão" (ou casos claros) de aplicação do conceito de Direito?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Casos-padrão são aquelas situações em que a presença do fenômeno jurídico é incontroversa: uma lei votada pelo parlamento, uma sentença proferida por um juiz, um contrato validamente celebrado. Eles servem de contraste aos "casos de fronteira", em que a certeza sobre haver ou não Direito diminui. Essa distinção é o instrumento que Hart usa para mostrar por que a definição de Direito é mais difícil do que parece à primeira vista.` },

    { id: 3, categoria: 'teoria', enunciadoHtml: `Por que o direito internacional e o chamado "direito primitivo" são citados por Hart como exemplos de "casos de fronteira"?`, alternativasHtml: [
    ...
    { id: 4, categoria: 'teoria', enunciadoHtml: `Segundo a linha do tempo histórica apresentada na disciplina, o que caracteriza a Lei das XII Tábuas (cerca de 450 a.C.)?`, alternativasHtml: [
      ...
      ], correta: 2, fonteExtra: false, explicacaoHtml: `A Lei das XII Tábuas é um marco romano bem anterior ao Corpus Juris Civilis de Justiniano (527 d.C.). Sua importância está em tornar públicas e conhecidas as normas que antes ficavam sob controle quase exclusivo dos patrícios, reduzindo a margem de manipulação na aplicação do Direito e dando maior previsibilidade aos cidadãos romanos, inclusive os plebeus.` },

    { id: 5, categoria: 'teoria', enunciadoHtml: `O Corpus Juris Civilis, de Justiniano (527 d.C.), é relevante para a história do Direito principalmente porque:`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `O Corpus Juris Civilis reuniu, sistematizou e organizou séculos de Direito Romano numa obra de referência, servindo de base para a redescoberta do Direito Romano na Europa medieval e para a formação da tradição romanística (civil law), da qual o Brasil é herdeiro. Não tem relação com a origem da common law, que se desenvolveu de modo distinto na Inglaterra, a partir do costume e do precedente judicial.` },

    { id: 6, categoria: 'teoria', enunciadoHtml: `Qual das alternativas apresenta corretamente a ordem cronológica de dois marcos históricos estudados?`, alternativasHtml: [
    ...
    { id: 7, categoria: 'teoria', enunciadoHtml: `O que caracteriza o chamado Jusnaturalismo teológico, associado a São Tomás de Aquino, na linha do tempo histórica do Direito?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `No Jusnaturalismo teológico, o Direito humano encontra seu fundamento último numa ordem racional divina (a lei eterna), da qual a razão humana consegue extrair princípios de justiça válidos universalmente. É um jusnaturalismo de base religiosa, distinto do Jusnaturalismo Contratualista dos séculos XVII e XVIII (Hobbes, Locke, Rousseau), que fundamenta o Direito e o poder político num pacto entre os próprios indivíduos.` },

    { id: 8, categoria: 'teoria', enunciadoHtml: `A frase de Ihering, "a paz é o fim do Direito, a luta é o meio", expressa a ideia de que:`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `Para Ihering, direitos não são simplesmente dados ou concedidos: costumam ser conquistados por meio de disputas (a "luta pelo Direito"). O objetivo dessa luta, porém, não é o conflito permanente, mas alcançar uma ordem pacífica e estável, em que os interesses reconhecidos como direitos possam ser exercidos sem necessidade de disputa constante.` },

    { id: 9, categoria: 'teoria', enunciadoHtml: `Segundo Kelsen (Teoria Pura do Direito), qual é a principal crítica feita à ciência jurídica de sua época?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `Kelsen buscava depurar a ciência jurídica de elementos que, para ele, não lhe eram próprios: explicações psicológicas sobre por que as pessoas obedecem à lei, explicações sociológicas sobre efeitos sociais das normas, juízos éticos sobre sua justiça, e disputas políticas sobre seu conteúdo ideal. Seu objetivo era isolar a norma jurídica como objeto específico de uma ciência jurídica "pura".` },

    { id: 10, categoria: 'teoria', enunciadoHtml: `O princípio "ubi societas ibi jus" (onde há sociedade, há Direito) é ilustrado, na perspectiva de São Tomás de Aquino, por três situações de isolamento social. Assinale a alternativa que as identifica corretamente.`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Mesmo os casos de isolamento social confirmam, em vez de contradizer, o princípio de que o normal é viver em sociedade. A má sorte (mala fortuna) isola alguém por circunstâncias alheias à vontade; a natureza corrompida (corruptio naturae) isola quem tem um vício antissocial; e a natureza excelente (excellentia naturae) isola quem é superior aos demais, como um sábio ou um santo eremita. Em todos os casos, a exceção confirma que o convívio social é a regra, e é nele que o Direito nasce.` },

    { id: 11, categoria: 'teoria', enunciadoHtml: `A linguagem jurídica, segundo a classificação estudada, organiza as condutas humanas em quatro categorias básicas. Quais são elas?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `Essa classificação organiza qualquer conduta possível em quatro categorias: há condutas que a norma obriga a fazer, condutas que proíbe, condutas que apenas permite fazer (facultativas) e condutas que permite não fazer (não obrigatórias). Essas categorias formam a estrutura básica de qualquer sistema de regras de conduta, jurídico ou não.` },

    { id: 12, categoria: 'teoria', enunciadoHtml: `Qual das alternativas exemplifica corretamente a distinção entre o papel do legislador e o papel do juiz?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `A lei, tal como criada pelo legislador, é geral e abstrata: fala para todos, sem se referir a uma pessoa ou situação específica. Cabe ao juiz, diante de um caso concreto, interpretar essa norma geral e aplicá-la àquela situação particular, individualizando o comando abstrato da lei. Essa divisão de papéis é central para entender um sistema jurídico baseado em normas escritas.` },

    { id: 13, categoria: 'teoria', enunciadoHtml: `Segundo a classificação estudada (Paulo Nader), quais são as três espécies de fontes do Direito?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `As fontes históricas são os documentos e registros do passado que revelam a origem de um instituto jurídico; as fontes materiais dizem respeito aos fatores sociais, econômicos e culturais que geram a necessidade de uma norma; e as fontes formais são os modos pelos quais o Direito se manifesta e se torna conhecido (a lei, o costume, a jurisprudência, os negócios jurídicos), podendo ser diretas ou indiretas.` },

    { id: 14, categoria: 'teoria', enunciadoHtml: `Para Miguel Reale, "toda fonte pressupõe uma estrutura de poder". Quais são as quatro fontes do Direito e as respectivas formas de poder a que correspondem?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Reale associa cada fonte formal a um tipo de poder social que a sustenta: a lei expressa o poder do órgão legislativo; a jurisdição expressa o poder dos tribunais ao decidir casos e formar precedentes; o costume expressa um poder social difuso, sem órgão centralizado; e o negócio jurídico expressa o poder da autonomia privada dos próprios particulares para regular suas relações.` },

    { id: 15, categoria: 'teoria', enunciadoHtml: `No Direito Romano, qual era a principal diferença entre o Jus Civile e o Jus Gentium?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `O Jus Civile era o direito próprio dos cidadãos romanos, aplicado pelo pretor urbano. O Jus Gentium surgiu da necessidade prática de regular relações que envolviam estrangeiros (não cidadãos), sendo aplicado pelo pretor peregrino. Essa distinção reflete a preocupação romana em diferenciar o direito interno de Roma do direito aplicável às relações com outros povos.` },

    { id: 16, categoria: 'teoria', enunciadoHtml: `O Corpus Juris Civilis, compilação de Justiniano, é tradicionalmente dividido em quatro partes. Quais são elas?`, alternativasHtml: [
    ...
    { id: 17, categoria: 'teoria', enunciadoHtml: `Qual é a diferença central entre a tradição do civil law (Direito Romanístico) e a tradição do common law?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Países de tradição romanística, como o Brasil, organizam seu Direito principalmente em códigos e leis escritas, atribuindo à lei o papel central de fonte do Direito. Países de common law, como Inglaterra e Estados Unidos, atribuem papel central ao precedente judicial e ao costume. Reale observa uma convergência recente: o civil law valoriza mais os precedentes (súmulas vinculantes), e o common law legisla mais por estatutos escritos.` },

    { id: 18, categoria: 'teoria', enunciadoHtml: `De acordo com Tércio Sampaio Ferraz Jr., qual é a origem etimológica dos termos "zetética" e "dogmática"?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Ferraz Jr. explica que zetética deriva de zetein, que significa perquirir, buscar, questionar; dogmática deriva de dokein, que significa ensinar, doutrinar. Essa raiz etimológica já antecipa a diferença de enfoque entre os dois: um voltado a manter a pergunta aberta, outro voltado a fixar respostas para orientar a ação.` },

    { id: 19, categoria: 'teoria', enunciadoHtml: `Na anedota de Sócrates e o soldado, usada por Ferraz Jr. para ilustrar a distinção zetético/dogmático, qual enfoque cada personagem representa?`, alternativasHtml: [
    ...
    { id: 20, categoria: 'teoria', enunciadoHtml: `Qual das alternativas descreve corretamente a diferença entre questões zetéticas e questões dogmáticas, segundo Ferraz Jr.?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Nas questões zetéticas, o problema é configurado como um "ser" (o que é algo?), e a investigação permanece aberta, podendo ser retomada indefinidamente. Nas questões dogmáticas, o problema é configurado como um "dever ser" (como deve ser decidido?), voltado a possibilitar uma decisão prática, por isso tratadas como finitas: em algum momento uma resposta operacional precisa ser dada.` },

    { id: 21, categoria: 'teoria', enunciadoHtml: `O que Ferraz Jr. (a partir de Luhmann) chama de "princípio da inegabilidade dos pontos de partida"?`, alternativasHtml: [
    ...
    { id: 24, categoria: 'teoria', enunciadoHtml: `No exemplo da greve de funcionário público, discutido por Ferraz Jr., qual é a diferença entre a postura do sociólogo do direito e a postura do jurista dogmático?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Para o sociólogo do direito, a legislação sobre a greve é apenas um dado entre outros, que pode até ser desprezado como ponto de partida para explicar o fenômeno social do movimento grevista. Já o jurista dogmático, por mais que se esmere em interpretações, não pode ignorar o ordenamento vigente: suas soluções para o caso concreto têm de ser propostas dentro dos limites da ordem jurídica estabelecida.` },

    { id: 25, categoria: 'teoria', enunciadoHtml: `Um advogado que vai defender a inconstitucionalidade de uma lei sobre união estável precisa, na prática, apenas do enfoque dogmático, sem qualquer necessidade de recorrer à zetética. Essa afirmação está:`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `Este é um exemplo típico de situação em que os dois enfoques se complementam na prática profissional. A dogmática fornece o instrumental técnico-normativo indispensável, mas a construção de uma tese sobre um tema socialmente controverso frequentemente se apoia também em argumentos zetéticos sobre a evolução dos costumes e da própria noção de família. Isso mostra que, na prática do operador do direito, os dois enfoques nem sempre são excludentes.` },

    { id: 26, categoria: 'teoria', enunciadoHtml: `Calcular o prazo de uma contestação ou verificar se uma petição inicial preenche os requisitos formais do <button type="button" class="citacao" data-dispositivo="cpc-319" aria-expanded="false" aria-controls="balao-dispositivo">art. 319 do CPC</button> são tarefas que, tipicamente, exigem:`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `Este é um exemplo de tarefa em que apenas a dogmática é necessária: o operador aplica a norma processual vigente diretamente ao caso, sem precisar reabrir uma discussão especulativa sobre a justiça ou a origem histórica dessas regras. É justamente esse tipo de situação cotidiana que compõe boa parte do trabalho técnico do operador do direito.` },

    { id: 27, categoria: 'teoria', enunciadoHtml: `Um pesquisador que investiga por que juízes de um mesmo tribunal decidem de forma diferente casos semelhantes, sem nenhum compromisso com uma solução prática imediata para algum processo, está atuando:`, alternativasHtml: [
    ...
    { id: 30, categoria: 'teoria', enunciadoHtml: `Na "teoria dos círculos", qual autor defende que Direito e Moral são círculos independentes, sem relação lógica necessária entre eles?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `Bentham representa Direito e Moral como círculos concêntricos, em que a Moral (maior) engloba totalmente o Direito (menor). Du Pasquier os representa como círculos secantes, que se cruzam parcialmente. Kelsen, coerente com sua Teoria Pura, defende que os dois são círculos independentes, negando qualquer relação lógica necessária entre validade jurídica e validade moral. Jellinek propõe que o Direito é o "mínimo ético" exigido coercitivamente, ideia contraposta ao "máximo ético" de Schmoller.` },

    { id: 31, categoria: 'teoria', enunciadoHtml: `Quais são os caracteres apontados para as Regras de Trato Social (como as regras de etiqueta e cortesia)?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `As Regras de Trato Social têm natureza social e exterior (dizem respeito à conduta observável), mas são unilaterais e heterônomas (impostas pelo grupo, sem gerar um direito exigível de outra pessoa) e incoercíveis. Sua sanção é difusa (reprovação social, não uma pena jurídica), e variam conforme a classe social ou a cultura de cada grupo, ao contrário do Direito, que busca aplicar-se de modo geral dentro de seu âmbito de validade.` },

    { id: 32, categoria: 'teoria', enunciadoHtml: `No quadro comparativo final entre Direito, Moral, Regras de Trato Social e Preceitos Religiosos, qual das seguintes afirmações está correta?`, alternativasHtml: [
    ...
    { id: 33, categoria: 'teoria', enunciadoHtml: `Segundo Aristóteles, qual é a distinção entre physikón díkaion e nomikón díkaion?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Essa distinção aristotélica, discutida por Bobbio, está na origem histórica da separação entre direito natural e direito positivo. O justo por natureza (physikón díkaion) teria validade universal, independentemente do que cada povo decidisse; o justo por convenção (nomikón díkaion) dependeria da lei e do costume de cada comunidade, podendo variar de um lugar para outro.` },

    { id: 34, categoria: 'teoria', enunciadoHtml: `Como São Tomás de Aquino organiza, em ordem, os diferentes tipos de lei em sua teoria?`, alternativasHtml: [
    ...
    { id: 36, categoria: 'teoria', enunciadoHtml: `O que a Declaração dos Direitos do Homem e do Cidadão (1789), em seus arts. 1º e 2º, afirma sobre os direitos naturais?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `A Declaração de 1789 é o momento em que a teoria jusnaturalista contratualista deixa de ser apenas uma construção filosófica e se converte em projeto político concreto. Seus arts. 1º e 2º afirmam a igualdade e liberdade natural dos homens e colocam a proteção desses direitos, anteriores e superiores ao próprio Estado, como finalidade de qualquer associação política.` },

    { id: 37, categoria: 'teoria', enunciadoHtml: `O Código Civil de Napoleão (1804) é apontado como um marco de consolidação de qual corrente?`, alternativasHtml: [
    ...
    { id: 39, categoria: 'teoria', enunciadoHtml: `Qual é a principal diferença entre a concepção de soberania em Locke e em Hobbes?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `Enquanto Hobbes concentra um poder absoluto e irrevogável nas mãos do soberano para evitar o retorno ao estado de guerra, Locke, considerado o pai do liberalismo político, limita esse poder pelo próprio contrato e pela lei natural, reconhecendo direitos básicos que o governo não pode violar, e admitindo que o povo resista a um governo que rompa esse pacto.` },

    { id: 40, categoria: 'teoria', enunciadoHtml: `Segundo Pachukanis, aplicando o método de Marx à teoria geral do direito, a totalidade concreta (sociedade, Estado, população) deve ser tratada, numa investigação científica, como:`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `Pachukanis retoma o método descrito por Marx nos Grundrisse: em vez de partir de uma totalidade concreta vaga e indivisa, a investigação científica deve partir de categorias mais simples (no caso do direito, a relação jurídica) e, só progressivamente, reconstruir o concreto como uma totalidade rica de determinações. Por isso este bloco é sinalizado como aprofundamento: é um debate metodológico mais avançado, mas presente no material da disciplina.` },

    { id: 41, categoria: 'peticao', enunciadoHtml: `Segundo a estrutura de petição ensinada pelo professor, qual é a ordem correta das seções de uma petição inicial?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `Essa é a estrutura básica ensinada em sala, correspondente à lógica de qualquer petição inicial: primeiro identifica-se a quem a peça se dirige (Endereçamento), depois quem são as partes (Qualificação), em seguida o que aconteceu (Fatos), por que isso gera um direito (Direito), o que se pede (Pedidos) e, por fim, os elementos formais de fechamento (Encerramento).` },

    { id: 42, categoria: 'peticao', enunciadoHtml: `De acordo com o <button type="button" class="citacao" data-dispositivo="cpc-319-ii" aria-expanded="false" aria-controls="balao-dispositivo">art. 319, II, do CPC</button>, quais dados devem constar na qualificação do autor e do réu?`, alternativasHtml: [
    ...
    { id: 45, categoria: 'peticao', enunciadoHtml: `Segundo as "cinco perguntas de toda petição" ensinadas pelo professor, qual delas corresponde à tarefa de "procure a legislação aplicável a cada fato"?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `As cinco perguntas ensinadas são, na ordem: (1) procurar a legislação aplicável a cada fato; (2) contar os fatos em ordem cronológica; (3) identificar quem é autor e quem é réu; (4) identificar documentos e demais provas; (5) transformar o problema em pedidos concretos. A primeira é justamente o passo de mapear, desde o início, qual base legal vai sustentar cada fato relevante.` },

    { id: 46, categoria: 'peticao', enunciadoHtml: `Qual das alternativas corresponde corretamente à quinta e última das "cinco perguntas de toda petição"?`, alternativasHtml: [
      ...
      ], correta: 2, fonteExtra: false, explicacaoHtml: `Depois de identificar a legislação aplicável, narrar os fatos cronologicamente, qualificar as partes e levantar as provas, o último passo é converter tudo isso em pedidos concretos e determinados na seção "Dos Pedidos", que é justamente o que o juiz vai analisar e, se procedente, conceder na sentença.` },

    { id: 47, categoria: 'peticao', enunciadoHtml: `Segundo o modelo estudado, qual é a função do "Valor da Causa" dentro da estrutura da petição inicial?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `O <button type="button" class="citacao" data-dispositivo="cpc-319-v" aria-expanded="false" aria-controls="balao-dispositivo">art. 319, V, do CPC</button> exige que toda petição inicial indique o valor da causa, requisito com efeitos processuais relevantes. No modelo estudado, esse valor aparece com reticências, pois o caso não fornece o montante exato dos danos materiais, e a instrução da atividade é clara: não inventar dados que o enunciado não forneceu.` },

    { id: 48, categoria: 'peticao', enunciadoHtml: `Qual das alternativas descreve corretamente o conteúdo típico da seção "Dos Fatos" de uma petição inicial, segundo o modelo estudado?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `"Dos Fatos" é a seção narrativa da petição: conta, de forma objetiva e cronológica, o que efetivamente aconteceu, sem ainda desenvolver os argumentos jurídicos. É em "Do Direito" que esses fatos serão conectados às normas aplicáveis, e nos "Pedidos" que se converterá tudo em uma pretensão concreta.` },

    { id: 49, categoria: 'peticao', enunciadoHtml: `Segundo o modelo de petição estudado, qual expressão de fechamento é utilizada antes da indicação de local, data e assinatura do advogado?`, alternativasHtml: [
      ...
      ], correta: 1, fonteExtra: false, explicacaoHtml: `"Termos em que pede e espera deferimento" é a fórmula de encerramento clássica usada em petições, imediatamente antes da indicação do local e data e da assinatura do advogado com seu número de inscrição na OAB. É um elemento formal padronizado, presente também no modelo do caso Juliana Silva x Renata Rocha.` },

    { id: 50, categoria: 'peticao', enunciadoHtml: `Por que, segundo a nota do professor no material "para não esquecer", o nível de exigência esperado no 1º período em relação à redação de uma petição deve ser "pouca discussão doutrinária, bastante" aplicação prática?`, alternativasHtml: [
      ...
      ], correta: 0, fonteExtra: false, explicacaoHtml: `A observação do professor reconhece que, no primeiro período, o estudante ainda está construindo o domínio básico da estrutura processual e da aplicação da lei aos fatos. Por isso, o nível adequado de exigência prioriza a aplicação prática e organizada da legislação já indicada, em vez de exigir um aprofundamento doutrinário próprio de etapas mais avançadas do curso.` },

    { id: 51, categoria: 'fundamentos', fonteExtra: false, enunciadoHtml: `Segundo o <button type="button" class="citacao" data-dispositivo="cpc-319" aria-expanded="false" aria-controls="balao-dispositivo">art. 319 do CPC</button>, quais elementos, entre outros, a petição inicial deve indicar?`, alternativasHtml: [
      ...
      ], correta: 0, explicacaoHtml: `O <button type="button" class="citacao" data-dispositivo="cpc-319" aria-expanded="false" aria-controls="balao-dispositivo">art. 319 do CPC</button> lista, em seus incisos, os elementos estruturais de qualquer petição inicial: o juízo a que se dirige (I), a qualificação completa das partes (II), o fato e os fundamentos jurídicos do pedido (III), o pedido com suas especificações (IV), o valor da causa (V) e as provas com que se pretende demonstrar a verdade dos fatos alegados (VI). Esses elementos formam o esqueleto básico estudado na disciplina.` },

    { id: 52, categoria: 'fundamentos', fonteExtra: false, enunciadoHtml: `O <button type="button" class="citacao" data-dispositivo="cpc-319-ii" aria-expanded="false" aria-controls="balao-dispositivo">inciso II do art. 319 do CPC</button> exige, entre os dados de qualificação das partes, a indicação de:`, alternativasHtml: [
    ...
    { id: 53, categoria: 'fundamentos', fonteExtra: true, enunciadoHtml: `O <button type="button" class="citacao" data-dispositivo="cpc-320" aria-expanded="false" aria-controls="balao-dispositivo">art. 320 do CPC</button>, artigo correlato ao <button type="button" class="citacao" data-dispositivo="cpc-319" aria-expanded="false" aria-controls="balao-dispositivo">art. 319</button> (que trata dos requisitos da petição inicial), estabelece que:`, alternativasHtml: [
      ...
      ], correta: 0, explicacaoHtml: `Atenção: o <button type="button" class="citacao" data-dispositivo="cpc-320" aria-expanded="false" aria-controls="balao-dispositivo">art. 320 do CPC</button> não é um dos quatro artigos-base do material da disciplina (<button type="button" class="citacao" data-dispositivo="cpc-319" aria-expanded="false" aria-controls="balao-dispositivo">art. 319 do CPC</button>, art. 5º, <button type="button" class="citacao" data-dispositivo="cf-5-v" aria-expanded="false" aria-controls="balao-dispositivo">V</button> e <button type="button" class="citacao" data-dispositivo="cf-5-x" aria-expanded="false" aria-controls="balao-dispositivo">X</button>, da CF, e arts. <button type="button" class="citacao" data-dispositivo="cc-186" aria-expanded="false" aria-controls="balao-dispositivo">186</button> e <button type="button" class="citacao" data-dispositivo="cc-927" aria-expanded="false" aria-controls="balao-dispositivo">927</button> do CC). Ele foi incluído aqui como artigo correlato ao <button type="button" class="citacao" data-dispositivo="cpc-319" aria-expanded="false" aria-controls="balao-dispositivo">art. 319</button>, por tratar do mesmo tema, exigindo que a peça venha acompanhada dos documentos indispensáveis à demonstração mínima da pretensão (no caso estudado, os orçamentos e comprovantes dos danos). Este artigo é complementar, não está nos materiais-base da disciplina, foi acrescentado para aprofundar o tema.` },

    { id: 54, categoria: 'fundamentos', fonteExtra: false, enunciadoHtml: `O <button type="button" class="citacao" data-dispositivo="cf-5-v" aria-expanded="false" aria-controls="balao-dispositivo">art. 5º, inciso V, da Constituição Federal</button> assegura:`, alternativasHtml: [
    ...
    { id: 55, categoria: 'fundamentos', fonteExtra: false, enunciadoHtml: `O <button type="button" class="citacao" data-dispositivo="cf-5-x" aria-expanded="false" aria-controls="balao-dispositivo">art. 5º, inciso X, da Constituição Federal</button> declara invioláveis:`, alternativasHtml: [
      ...
      ], correta: 0, explicacaoHtml: `O <button type="button" class="citacao" data-dispositivo="cf-5-x" aria-expanded="false" aria-controls="balao-dispositivo">inciso X do art. 5º da CF</button> protege a intimidade, a vida privada, a honra e a imagem das pessoas, garantindo indenização pelo dano material ou moral decorrente de sua violação. No caso estudado, embora o dano seja material, esse dispositivo é citado como reforço geral do dever constitucional de indenizar danos decorrentes de violação a direitos, ao lado do <button type="button" class="citacao" data-dispositivo="cf-5-v" aria-expanded="false" aria-controls="balao-dispositivo">inciso V</button>.` },

    { id: 56, categoria: 'fundamentos', fonteExtra: true, enunciadoHtml: `O <button type="button" class="citacao" data-dispositivo="cf-5-xxxv" aria-expanded="false" aria-controls="balao-dispositivo">art. 5º, inciso XXXV, da Constituição Federal</button>, correlato aos incisos <button type="button" class="citacao" data-dispositivo="cf-5-v" aria-expanded="false" aria-controls="balao-dispositivo">V</button> e <button type="button" class="citacao" data-dispositivo="cf-5-x" aria-expanded="false" aria-controls="balao-dispositivo">X</button> estudados no caso, estabelece o chamado princípio da inafastabilidade da jurisdição, segundo o qual:`, alternativasHtml: [
      ...
      ], correta: 0, explicacaoHtml: `Atenção: este inciso não é um dos quatro artigos-base do material da disciplina, mas foi incluído como correlato ao art. 5º já estudado, por tratar do mesmo dispositivo constitucional. Ele garante que qualquer lesão ou ameaça a direito, como os danos sofridos pela autora no caso estudado, possa ser levada à apreciação do Poder Judiciário, sendo o fundamento último do próprio direito de ajuizar a ação. Este artigo é complementar, não está nos materiais-base da disciplina, foi acrescentado para aprofundar o tema.` },

    { id: 57, categoria: 'fundamentos', fonteExtra: false, enunciadoHtml: `O <button type="button" class="citacao" data-dispositivo="cc-186" aria-expanded="false" aria-controls="balao-dispositivo">art. 186 do Código Civil</button> define ato ilícito como a conduta de quem:`, alternativasHtml: [
      ...
      ], correta: 0, explicacaoHtml: `O <button type="button" class="citacao" data-dispositivo="cc-186" aria-expanded="false" aria-controls="balao-dispositivo">art. 186 do CC</button> é a base da responsabilidade civil subjetiva no Direito brasileiro: comete ato ilícito quem, por ação ou omissão voluntária, negligência ou imprudência, viola direito e causa dano a outrem. No caso estudado, a omissão negligente da ré na manutenção da tubulação de seu apartamento, que causou a infiltração no imóvel da autora, configura exatamente esse tipo de conduta ilícita.` },

    { id: 58, categoria: 'fundamentos', fonteExtra: true, enunciadoHtml: `O <button type="button" class="citacao" data-dispositivo="cc-187" aria-expanded="false" aria-controls="balao-dispositivo">art. 187 do Código Civil</button>, correlato ao <button type="button" class="citacao" data-dispositivo="cc-186" aria-expanded="false" aria-controls="balao-dispositivo">art. 186</button> estudado no caso, trata do chamado abuso de direito, considerando também ato ilícito a conduta de quem:`, alternativasHtml: [
